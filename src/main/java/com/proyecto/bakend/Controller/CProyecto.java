...
import com.proyecto.bakend.Dto.dtoProyecto;
import com.proyecto.bakend.Entity.Proyecto;
import com.proyecto.bakend.Security.Controller.Mensaje;
import com.proyecto.bakend.Service.Sproyecto;
...
public class CProyecto {
    ...
    public ResponseEntity<?>create(@RequestBody dtoProyecto dtoproyecto){
        ...
        if(StringUtils.isBlank(dtoproyecto.getDescripcionP())){
            return new ResponseEntity(new Mensaje("El nombre de la descripcion es obligatoria"),HttpStatus.BAD_REQUEST);
        }
